...
# # Removes if found, no error if missing
...
# # # 1. Union ... Below fuction works the same way with the same output results
# print(set1 | set2)
# # print(set1.union(set2))

# # 2. Intersection
# # print(set1 & set2) # choice 1 step to use intersection
# # print(set1.intersection(set2)) # choice 2 step to use intersection
# # the choice doing the same functions
...
visitors = set()
visitors_1 + visitors_2 + visitors_3 = visitors
# Adding visitors
visitors_1.add(input("input for Name :"))
visitors_2.add(input("second Name of Your Choice :"))
visitors_3.add(input(" Input the last person Name :")) # Duplicate, ignored automatically
print("Visitors:", visitors)
